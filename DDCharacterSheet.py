...
class DDCharacterSheet:
    ...
    def __init__(self, master):
        ...
        self.minStr = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "str", "-"), text="-", padx=7, pady=0)
        self.minStr.grid(column = 1, row = 16, sticky = "E")
        self.addStr = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "str", "+"), text="+", padx=5, pady=0)
        ...
        self.minDex = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "dex", "-"), text="-", padx=7, pady=0)
        self.minDex.grid(column = 1, row = 17, sticky = "E")
        self.addDex = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "dex", "+"), text="+", padx=5, pady=0)
        ...
        self.minCon = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "con", "-"), text="-", padx=7, pady=0)
        self.minCon.grid(column = 1, row = 18, sticky = "E")
        self.addCon = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "con", "+"), text="+", padx=5, pady=0)
        ...
        self.minInt = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "int", "-"), text="-", padx=7, pady=0)
        self.minInt.grid(column = 1, row = 19, sticky = "E")
        self.addInt = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "int", "+"), text="+", padx=5, pady=0)
        ...
        self.minWis = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "wis", "-"), text="-", padx=7, pady=0)
        self.minWis.grid(column = 1, row = 20, sticky = "E")
        self.addWis = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "wis", "+"), text="+", padx=5, pady=0)
        ...
        self.minChr = tk.Button(root, command=lambda: DDCharacterSheetLogic.adjustPoint(self, "chr", "-"), text="-", padx=7, pady=0)
